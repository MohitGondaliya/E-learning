...
import ChapterCardSlider, { type ActiveCourse } from "../../shared/component/ChapterCardSlider";
      ...
      <Grid container spacing={lgBreakPoint ? 2 : 3}>
        ...
        <Grid size={{ xl: 3, xs: 12 }}>
          <Grid container spacing={lgBreakPoint ? 2 : 4} sx={{
            ...
            <Grid size={{ xl: 12, md: 6, xs: 12 }} sx={{ display: { lg: 'flex' }, minHeight: { lg: '100%' }, flexGrow: '1!important', flexDirection: 'column' }}>
              <Typography variant="h5" className="mb-12p" color="black">
                Today&rsquo;s Task
              </Typography>
              <Card sx={{ display: 'flex', flexDirection: 'column', flexGrow: 1, minHeight: { xxl: '100%', md: 240, xs: 340 } }} >
