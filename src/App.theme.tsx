    ...
    components: {
            ...
            styleOverrides: {
                ...
                colorInherit: {
                    '&.btn-white': {
                        ...
                        border: "1px solid #B3C3CC8F",
                        boxShadow: "0px 2px 8px 0px #959DA529",
                        '&:hover, &:focus': {
                            backgroundColor: "rgba(179, 195, 204, 0.2)",
                        },
                        '&.active': {
        ...
        MuiChip: {
            styleOverrides: {
                ...
                filledInfo: {
                    backgroundColor: [LearningTheme.palette.info.main],
                    '& .MuiChip-label': {
                        color: '#FFFFFF',
                    },
                },
                filledWarning: {
                    backgroundColor: [LearningTheme.palette.warning.main],
                    '& .MuiChip-label': {
                        color: '#FFFFFF',
                    },
                },
