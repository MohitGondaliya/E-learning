import { Avatar, Button, Grid, ListItemIcon, ListItemText, Menu, MenuItem, Typography, useMediaQuery } from "@mui/material";
            ...
            <Grid container spacing={2} justifyContent="space-between" alignItems="center">
                <Grid size={'auto'}>
                    <Grid container spacing={1} alignItems="center">
                        ...
                        <Grid size="auto" className="d-lg-block d-none">
                ...
                <Grid size="grow">
                    <Grid container spacing={2} alignItems="center" justifyContent="flex-end">
                        <Grid size="auto">
                            <Typography variant="body1" color="#001D2D" className="d-flex align-items-center" sx={{ gap: 1 }} component="div">
                                {isSMScreen && ('Your Progress')} <CircularWithValueLabel className="circle-lg" value={42} />
                            </Typography>
                        </Grid>
                        <Grid size="auto">
