...
import { Accordion, AccordionDetails, AccordionSummary, Avatar, Button, Card, CardContent, Chip, FormControlLabel, Grid, Radio, RadioGroup, ToggleButton, ToggleButtonGroup, Typography } from "@mui/material";
...
import type { FullCourseCard } from "../../../shared/component/CourseCard";
        ...
        <>
            ...
            <div className="course-details-page">
                <Grid container spacing={3} className="mb-3" sx={{ flexWrap: { xl: 'nowrap' } }}>
                    <Grid size={{ xl: 'grow', lg: 8, xs: 12 }} sx={{ minWidth: { xl: 'calc(100% - 399px)' }, maxWidth: { xl: 'calc(100% - 399px)' } }}>
                                        ...
                                        <div className="course-highlight">
                                            <div className="course-all-feature">
                                                <Grid alignItems="center" container sx={{ marginLeft: { lg: '-24px', xs: '-12px' }, width: { lg: 'calc(100% + 24px)', xs: 'calc(100% + 12px)' } }}>
                                                    <Grid size={{ xl: 'auto', lg: 6, md: 3, xs: 6 }}>
                                                            ...
                                                            <li key={index}>
                                                                <Link to="#" title={chapter.title}>
                                                                    ...
                                                                    <div className="listing-detail">
                                                                        <Typography variant="body1" color="text.primary" className="title">
                                                                            {chapter.title}
                                                                        </Typography>
                                                                        <ul className="micro-feature">
                                                                            <li>
                    ...
                    <Hidden down="lg">
                        <Grid size={{ lg: 4, xs: 12 }} sx={{ minWidth: { xl: 375 }, maxWidth: { xl: 375 } }}>
                            <Grid container spacing={3} className="sticy-right">
                                <Grid size={{ lg: 12, md: 6, xs: 12 }} className="pt-lg-0">
                                    <Typography variant="h5" className="mb-12p" color="black">
                                        Choose a Plan
                                    </Typography>
                                    <Card className="min-h-auto">
