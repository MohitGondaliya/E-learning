...
import { Card, CardContent, Grid, Typography, Button, Chip, Avatar, useMediaQuery, Box } from "@mui/material";
                    ...
                    <CardContent>
                        <Grid container spacing={2}>
                            ...
                            <Grid size={{ md: 'grow', xs: 12 }}>
                                <Box className="next-course-card">
                                    <Typography variant="caption" className="next-title">Next Chapter</Typography>
                                    <Link className="link" to={ROUTES.Explore} title={course.nextChapter}>
                                        <Typography variant="h6" color="black" className="mb-4p" onClick={() => { navigate(ROUTES.CourseTrack) }}>
                                            {course.nextChapter}
                                        </Typography>
                                    </Link>
                                    ...
                                    <Button className="btn-action" color="primary" variant="text" size="medium" startIcon={<Avatar variant="square" src={images.PlayOutlined} alt="Time" sx={{ width: '24px!important', height: '24px!important' }} />} onClick={() => { navigate(ROUTES.CourseTrack) }}>
                                        Start
                                    </Button>
