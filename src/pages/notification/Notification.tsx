                ...
                <CardContent className="py-0">
                    <ul>
                        ...
                        <li className="notification">
                            ...
                            <div className="action">
                                <Button variant="outlined" size="medium" color="primary" onClick={() => { navigate(ROUTES.Schedule) }}>Go to Schedule</Button>
                            </div>
                        </li>
                        <li className="notification">
                            <div className="left">
                            ...
                            <div className="action">
                                <Button variant="outlined" size="medium" color="primary" onClick={() => { navigate(ROUTES.CourseDetails) }}>Go to Course</Button>
                            </div>
                        </li>
                        <li className="notification">
                            <div className="left">
