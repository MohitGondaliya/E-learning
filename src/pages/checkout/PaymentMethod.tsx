import { Avatar, Checkbox, FormControl, FormControlLabel, Grid, InputLabel, MenuItem, OutlinedInput, Radio, RadioGroup, Select, ToggleButton, ToggleButtonGroup, Typography, type SelectChangeEvent } from "@mui/material";
                                        ...
                                        >
                                            <Grid container spacing={2}>
                                                {savedUPIs.map((upi, index) => {
                                                    ...
                                                    return (
                                                        <Grid size={{ lg: 2, md: 3, sm: 4, xs: 6 }} key={upiId}>
                                                            <FormControlLabel
                                        ...
                                        >
                                            <Grid container spacing={2}>
                                                {savedCards.map((card, index) => {
                                                    ...
                                                    return (
                                                        <Grid size={{ md: 3, sm: 6, xs: 12 }} key={cardId}>
                                                            <FormControlLabel
                                ...
                                >
                                    <Grid container spacing={2}>
                                        {savedBanks.map((card, index) => {
                                            const cardId = `card_${index}`;
                                            return (
                                                <Grid size={{ lg: 2, md: 3, sm: 4, xs: 6 }} key={cardId}>
                                                    <FormControlLabel
