                            ...
                            : (
                                <Grid container spacing={3}>
                                    {savedCards.map((card, index) => {
                                        ...
                                        return (
                                            <Grid size={{ md: 3, sm: 4, xs: 12 }} key={index}>
                                                <Card className="save-payment-card">
                                                    <CardContent>
                                                        <Button className="MuiIconButton" variant="text" size="small" color="primary" aria-haspopup="true"
                                                            aria-expanded={cardAnchorEl[cardId] ? 'true' : undefined} onClick={(event) => handleClickCard(cardId, event)}>
                                    ...
                                    <Grid size={{ md: 3, sm: 4, xs: 12 }}>
                                        <Card className="add-new-card">
                                            <CardContent>
                                                ...
                                                <Typography variant="body1" className="fw-700 text-center" color="text.primary">
                            ...
                            : (
                                <Grid container spacing={3}>
                                    {savedUPIs.map((upi, index) => {
                                        ...
                                        return (
                                            <Grid size={{ lg: 2, md: 3, sm: 4, xs: 12 }} key={index}>
                                                <Card className="save-payment-card">
                                                    <CardContent>
                                                        <Button className="MuiIconButton" variant="text" size="small" color="primary" aria-haspopup="true"
                                                            aria-expanded={upiAnchorEl[upiId] ? 'true' : undefined} onClick={(event) => handleClickUPI(upiId, event)}>
                                                            <Avatar src={images.MoreOutlinedPrimary} variant="rounded" alt="More" sx={{ width: 20, height: 20 }} />
                                                        </Button>
                                                        <Menu
