import { Avatar, Box, Button, Dialog, DialogContent, DialogTitle, FormControl, Grid, IconButton, OutlinedInput, Typography } from "@mui/material";
import { Link, useNavigate } from "react-router-dom";
import images from "../../assets/images";
import CartItem, { type CartItemCard } from "../../shared/component/CartItem";
                                ...
                                <div className={`apply-coupon ${AppliedCoupon ? 'applied' : ''}`}>
                                    {AppliedCoupon ? (
                                        <Grid container spacing={2} justifyContent="space-between">
                                            <Grid size={{ xs: 'grow' }} className="d-flex align-items-center">
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid size={12}>
                                            <Grid container spacing={1} justifyContent="space-between">
                                                <Grid size={{ xs: 'auto' }} className="d-flex align-items-center">
            ...
            >
                ...
                <DialogContent className='verify-otp-dialog'>
                    ...
                    <Grid container spacing={4} justifyContent="center">
                        ...
                        <Grid size={12} className="py-1">
                            <Typography variant='h6' color="text.secondary" className='fw-400 mx-auto' sx={{ maxWidth: 488 }}>You have been successfully enrolled in the course. <Box sx={{ display: { xs: 'block', md: 'none' } }}><br /></Box> Begin your learning journey now.</Typography>
                        </Grid>
                        <Grid size={12} className="mb-md-4">
